		...
		request.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				...
				if (eu_country_codes.indexOf(data.countryCode) != -1) {
					...
					<div class="cookieconsent" style="position:fixed;padding:2px;left:0;bottom:0;background-color:rgba(0,0,0,0.8);color:#FFF;text-align:center;width:100%;z-index:99999;">\
